...
class sendEmail extends BaseController
{
	...
	{
		$this->email->setFrom('no-reply@salamdjourney.com','no-reply@salamdjourney.com');
		$this->email->setTo('febriansyah@gmail.com');

		$this->email->setSubject('Testing Email CI4');

		$this->email->setMessage('<h1>Test Email CI4</h1>');
